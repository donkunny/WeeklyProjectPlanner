            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="index.html">
                        ...
                        <!--This is dark logo icon--><img src="${pageContext.request.contextPath}/resources/plugins/images/admin-logo.png" alt="home" class="dark-logo" /><!--This is light logo icon--><img src="${pageContext.request.contextPath}/resources/plugins/images/admin-logo-dark.png" alt="home" class="light-logo" />
                     </b>
                        <!-- Logo text image you can use text also --><span class="hidden-xs">
                        <!--This is dark logo text--><img src="${pageContext.request.contextPath}/resources/plugins/images/admin-text.png" alt="home" class="dark-logo" /><!--This is light logo text--><img src="${pageContext.request.contextPath}/resources/plugins/images/admin-text-dark.png" alt="home" class="light-logo" />
                     </span> </a>
                </div>
                <!-- /Logo -->
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="javascript:void(0)" class="waves-effect">영업<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/view/table/sales/finishChartProjectTeam.jsp">완료</a></li>
                                </ul>
                            </li>
                            <li><a href="javascript:void(0)" class="waves-effect">지원<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li><a href="${pageContext.request.contextPath}/view/table/management/progressChartProjectTeam.jsp">진행</a></li>
                                    <li><a href="${pageContext.request.contextPath}/view/table/management/finishChartProjectTeam.jsp">완료</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
