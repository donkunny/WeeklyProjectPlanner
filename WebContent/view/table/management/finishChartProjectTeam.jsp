...
var groups = new vis.DataSet([
  ...
  var items = new vis.DataSet([
    {id: 0, group: 0, value: 0.2, content: 'item 0', start: new Date(2017, 3, 17), end: new Date(2017, 12, 21)},
    {id: 2, group: 1, value: 0.2, content: 'item 2', start: new Date(2017, 3, 16), end: new Date(2017, 3, 24)},
    {id: 5, group: 2, value: 0.2, content: 'item 5', start: new Date(2017, 3, 24), end: new Date(2017, 3, 27)}
  ]); 
